...
2. Регистрируемся на сайтах указанных в задании, затем вставляем ссылки на эти сайты в файл _index.md в директории хьюго сервера по следуюшему пути content/authors/admin/_index.md ( Скриншот 2 ).
...
Четвертый этап проеткной работы выполнен.
